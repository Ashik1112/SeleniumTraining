...
public class RecorderScript {
	...
	*/
	...
	//System.setProperty("webdriver..driver","C:/Users/sanjayp/eclipse-workspace-PicnicSelenium/SeleniumProject/drivers/geckodriver.exe");
	...
	public void testParameterWithXML() throws InterruptedException, ATUTestRecorderException{
		ATUTestRecorder recorder = new ATUTestRecorder("G:\\","myvideo",false);
		recorder.start(); 
